...
- [Complete setup of repo](https://docs.docker.com/install/), [select a storage driver](https://docs.docker.com/storage/storagedriver/select-storage-driver/), and complete installation of Docker
